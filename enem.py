...
class enem:
	...
	def __init__(self, x, y, w, h, color, speed, a, images, size, sounds, obs_map, material=0):
...
#                return i
#        return None
		if self.obs_map[int(x / 10)][int(y / 10)][0] == True:
			return self.obs_map[int(x / 10)][int(y / 10)][1]
		else:
			return None
