...
class coso:#el jugador
    ...
    def __init__ (self,x,y,w,h,color,images,size): #eventualmente iria otra informacion como el color de la linea
        ...
        if b == None or self.can_climb:
            ...
            if grav: #si el metodo fue llamado desde la funcion gravity
                if self.g > 0: #si la caja esta subiendo
                    if self.g > 7:
                        snd_step1.stop()
                        snd_step1.set_volume(1)
                        snd_step1.play()
                        self.ruido = True
                    elif self.g >1:
                        snd_step1.stop()
                        snd_step1.set_volume(0.4)
                        snd_step1.play()
    ...
    def throw_dust(self,lights,dire,cant, am, t=None):
        a = dust(self.data['x'],self.data['y'],white,am,am,dire,cant,self.g, t)
        lights.append(a)
